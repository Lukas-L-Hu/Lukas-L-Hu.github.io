...
export default function Projects({ ription, imageUrl, techStack, repoLink, liveLink }) {
    return (
        ...
        <div className="flex flex-col items-center px-4 pt-16 pb-12">
            ...
            <Project title="AI Wordle" techStack={["Python"]} description={"An automated AI agent for solving Wordle in as efficient amount of guesses as possible. This project uses an entropy-based strategy, leveraging information gain to systematically reduce uncertainty and make the most optimal Wordle guesses."}/>
            <Project title="Travel Wiz" techStack={["Node.js", "React.js", "HTML/CSS"]} description={"A React.js powered app that utilizes API calls to inform users of the best travel hacks and recommendations for users looking to travel. Users can choose a location by selecting a place on Google Maps which would provide tailored iteniraries."}/>
            <Project title="AI Minesweeper" techStack={["Python"]} description={"A Python interface with an AI agent that will play Minesweeper for the user. This involved optimizing weights and algorithms for choosing which tiles to uncover to avoid failure by uncovering a bomb. This project achieved an average success rate of over 80% for the intermediate difficulty."}/>
